        ...
        $(document).ready(function() {
            function updateLanguageContent(language) {
                if (language === 'en') {
                    ...
                    selectComp.textContent = 'تحديـــــد المُرافقِيـــــن';
                    selectComp.style.fontSize = '35px';
                    selectCompStyle.classList.add('text-right');
                    selectCompCont.textContent = 'حدّد المٌرافقِين المتواجدين معك حاليّا، أو أضف مٌرافق جديد';
                    ...
                    for (i = 0; i < gender.length; i++) {
                        ...
                        // console.log(genderDisplay[i].textContent);
                        if (genderDisplay[i].textContent === 'Male' || genderDisplay[i].textContent ===
                            'ذكر') {
                            // console.log(genderDisplay[i].textContent);
